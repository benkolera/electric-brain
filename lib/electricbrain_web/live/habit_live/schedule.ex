defmodule ElectricbrainWeb.HabitLive.Schedule do
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    {:ok,
     socket
     |> assign(:page_title, "Schedule · #{habit.title}")
     |> assign(:habit, habit)
     |> assign(:timing_form, timing_form(habit, user))
  ...
  defp timing_form(habit, user) do
    habit
